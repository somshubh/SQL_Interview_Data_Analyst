...
CREATE TABLE Employees (
  ...
  Department NVARCHAR(20) -- Changed from DeptNo to Department
);
...
select e1.Department, Emp_Name, Job_Name,Manager_Id, HireDate, Salary from Employees e1 where Salary > (
