...
select DATENAME(WEEK,date) as week, round(AVG(amount_spent),2) average_amount from user_purchases where day_name = 'Friday'
and YEAR(date) = '2023' and DATENAME(QUARTER,date) =1
