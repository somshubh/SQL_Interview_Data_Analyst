...
select  
cast(avg(case when c.gender = 'Male' then total_amount end) as decimal(5,2)) as Male_Avg_Amount,
cast(avg(case when c.gender = 'Female' then total_amount end) as decimal(5,2)) as Female_Avg_Amount
